...
class AdWordsIntegrationTest(unittest.TestCase):
  ...
  def testWithInvalidUserAgent(self):
    """Tests instantiation of an AdWords client with an invalid user agent.
    ...
    self.assertRaises(
        ValidationError, self._CreateAdWordsClient, oauth2_credential, ' ')
  ...
  def _CreateAdWordsClient(self, oauth2_credential, user_agent=USER_AGENT):
    ...
    Args:
      ...
      user_agent: str representing the user agent making the request.
