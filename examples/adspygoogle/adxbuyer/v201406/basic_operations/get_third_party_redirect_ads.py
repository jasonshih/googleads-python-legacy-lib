...
"""This example gets all third party ads for a given ad group. To add a third
party ad, add_third_party_redirect_ad.py.
...
def main(client, ad_group_id):
  ...
  ad_group_ad_service = client.GetAdGroupAdService(version='v201406')
