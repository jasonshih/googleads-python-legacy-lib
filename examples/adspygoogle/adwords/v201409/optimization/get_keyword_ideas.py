...
def main(client):
  ...
  targeting_idea_service = client.GetTargetingIdeaService(version='v201409')
    ...
    if 'entries' in page:
      for result in page['entries']:
        ...
        print ('Keyword with \'%s\' text and average monthly search volume '
               ...
               % (attributes['KEYWORD_TEXT'].get('value'),
                  attributes['SEARCH_VOLUME'].get('value'),
                  attributes['CATEGORY_PRODUCTS_AND_SERVICES'].get('value')))
      print
    else:
