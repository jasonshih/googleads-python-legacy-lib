...
def main(client, campaign_id):
  ...
  feed_service = client.GetFeedService(version='v201402')
  feed_item_service = client.GetFeedItemService(version='v201402')
  feed_mapping_service = client.GetFeedMappingService(version='v201402')
  campaign_feed_service = client.GetCampaignFeedService(version='v201402')
