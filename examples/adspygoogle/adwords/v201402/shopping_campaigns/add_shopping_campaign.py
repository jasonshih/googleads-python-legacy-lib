...
def main(client, budget_id, merchant_id):
  ...
  c_result = client.GetCampaignService(version='v201402').Mutate(
  ...
  a_result = client.GetAdGroupService(version='v201402').Mutate(
  ...
  ad_result = client.GetAdGroupAdService(version='v201402').Mutate(
      ad_operations)[0]
